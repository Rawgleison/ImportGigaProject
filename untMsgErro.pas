...
resourcestring
  ...
  RsErrorMessage = 'FP Informática' + NativeLineBreak +
                   'Para tirar print dessa mensagem, entes clique em Detalhar' + NativeLineBreak +
                   'Mensagem de Erro.' + NativeLineBreak + NativeLineBreak;
...
begin
  ...
  try
    ...
    begin
      StackList := JclCreateThreadStackTraceFromID(True, FThreadID);
      if Assigned(StackList) then
      begin
